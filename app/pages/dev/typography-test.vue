    ...
    <div class="content-grid">
      <div class="breakout2 py-[var(--space-xl)]">
        ...
        <header class="mb-[var(--space-2xl)]">
          <h1
            class="pp-eiko-desktop-h1 text-[var(--theme-text-100)] mb-[var(--space-s)]"
          >
            Typography & Icons Test
          </h1>
          <p class="ibm-plex-sans-jp-desktop-p1 text-[var(--theme-text-60)]">
            Real-world usage patterns with theme-aware links, icons, and text
            styles
          </p>
        </header>
        ...
        <section ref="linksSection" class="mb-[var(--space-2xl)]">
          ...
          <div class="grid gap-[var(--space-l)]">
            ...
            <div>
              <h3
                class="pp-eiko-desktop-h3 text-[var(--theme-text-60)] mb-[var(--space-s)]"
              >
                Navigation with Icons
              </h3>
            ...
            <div>
              ...
              >
                This paragraph shows <strong>bold text</strong>,
                <em>italic text</em>, and
                <strong><em>bold italic</em></strong> combinations. It also
                contains
                <a
                  href="#"
            ...
            <div>
              ...
              <div class="flex gap-[var(--space-s)] flex-wrap">
                ...
                <button
                  class="nav-link p-[var(--space-xs)] bg-[var(--theme-15)] rounded-md text-[var(--theme-text-100)]"
                  :data-active="false"
                >
                  <Icon
        ...
        <section class="mb-[var(--space-2xl)]">
          ...
          <div class="grid gap-[var(--space-m)] md:grid-cols-2">
            ...
            >
              <div
                class="flex items-start gap-[var(--space-s)] mb-[var(--space-s)]"
              >
                <Icon
                ...
                <div>
                  <h3
                    class="pp-eiko-desktop-h3 text-[var(--theme-text-100)] mb-[var(--space-2xs)]"
                  >
                    Theme System
                  </h3>
                  <p
              ...
              >
                All colors and animations are
                <strong>centralized in design tokens</strong> for consistent
                theming. <em>Icons inherit theme colors</em> automatically.
              </p>
              <a
                href="/dev/colors"
                class="text-link nav-link text-[var(--theme-text-100)] inline-flex items-center gap-[var(--space-2xs)] ibm-plex-sans-jp-desktop-p1"
                :data-active="false"
              >
                View colors
                <Icon
        ...
        <section class="mb-[var(--space-2xl)]">
          ...
          <article class="grid gap-[var(--space-m)] max-w-3xl">
            <p class="ibm-plex-sans-jp-desktop-p2 text-[var(--theme-text-100)]">
              ...
              <strong><em>bold italic</em></strong> text combinations in a
              larger size.
              <a
                href="/dev/typography"
                class="text-link nav-link text-[var(--theme-text-100)]"
            ...
            <blockquote
              class="pl-[var(--space-m)] border-l-4 border-[var(--theme-text-15)]"
            >
              <p
                class="ibm-plex-sans-jp-desktop-p2 text-[var(--theme-text-60)] italic"
              >
                "Typography is the craft of endowing human language with a
                durable visual form."
              </p>
              <footer
                class="ibm-plex-sans-jp-desktop-caption text-[var(--theme-text-40)] mt-[var(--space-xs)]"
              >
                — Robert Bringhurst
              </footer>
            </blockquote>
            ...
            <div
              class="flex items-start gap-[var(--space-s)] p-[var(--space-s)] bg-[var(--theme-5)] rounded-lg"
            >
              <Icon
              ...
              <div>
                <p
                  class="ibm-plex-sans-jp-desktop-p1 text-[var(--theme-text-100)] mb-[var(--space-2xs)]"
                >
                  <strong>Info callout:</strong> Icons automatically inherit
                  theme colors
                </p>
                <p
                  class="ibm-plex-sans-jp-desktop-caption text-[var(--theme-text-60)]"

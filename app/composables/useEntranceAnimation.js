...
export const useEntranceAnimation = () => {
  ...
  const initialize = () => {
    ...
    masterTimeline = $gsap.timeline({
      ...
      onComplete: () => {
        ...
        console.log('🔓 Removed is-first-load class - page transitions can now handle visibility')
  ...
  const setupEntrance = (element, options = {}) => {
    ...
    if (inViewport) {
      ...
      console.log('👁️ Element not in viewport, using ScrollTrigger fallback:', element)
   ...
   */
  const setupScrollTriggerFallback = (element, animateFn, scrollTriggerConfig) => {

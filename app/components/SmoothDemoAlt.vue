      ...
      >
        ...
        <header class="text-center grid gap-[var(--space-xs)]">
          ...
          <p
            ...
            data-speed="0.96"
          >
            Advanced layouts with responsive grids, blockquotes, and callout
            boxes
          </p>
        </header>
        ...
        >
          ...
          <article class="order-2 grid gap-[var(--space-s)]">
            ...
            <p
              ...
              data-speed="0.94"
            >
              All spacing uses <strong>fluid tokens</strong> from the theme
              system, ensuring consistent spacing that scales across viewports.
            ...
            <p
              ...
              data-speed="1.02"
            >
              Typography automatically switches between <em>PP Eiko</em> and
              <em>IBM Plex Sans JP</em>
        ...
        >
          ...
          >
            <p
              class="ibm-plex-sans-jp-mobile-p2 md:ibm-plex-sans-jp-desktop-p2 text-[var(--theme-text-60)] italic"
            >
              "Typography is the craft of endowing human language with a durable
              visual form."
            </p>
            <footer
              class="ibm-plex-sans-jp-mobile-caption md:ibm-plex-sans-jp-desktop-caption text-[var(--theme-text-40)] mt-[var(--space-xs)]"
            >
              — Robert Bringhurst
            </footer>
          </blockquote>
        ...
        >
          ...
          >
            <Icon
              ...
              class="icon icon-lg icon-60 mt-1"
            />
            <div>
              <p
                class="ibm-plex-sans-jp-mobile-p1 md:ibm-plex-sans-jp-desktop-p1 text-[var(--theme-text-100)] mb-[var(--space-2xs)]"
              >
                <strong>Design Token Benefits:</strong> Icons inherit theme
        ...
        >
          <article class="order-2 md:order-1 grid gap-[var(--space-s)]">
            ...
            <p
              ...
              data-speed="0.95"
            >
              <strong class="text-[var(--theme-text-100)]">Mobile:</strong>
            ...
            <div class="mt-[var(--space-s)] grid gap-[var(--space-2xs)]">
              <p
                class="text-[var(--theme-text-60)] text-step-0 mb-[var(--space-2xs)]"
              >
                Nested background variants:
              </p>
              <div
                class="p-[var(--space-xs)] bg-[var(--theme-5)] border border-[var(--theme-text-15)] rounded"
              >
                <span
        ...
        <article class="grid gap-[var(--space-m)] max-w-3xl mx-auto">
          ...
          <p
            class="ibm-plex-sans-jp-mobile-p2 md:ibm-plex-sans-jp-desktop-p2 text-[var(--theme-text-100)]"
            data-speed="1.02"
          >
            <strong>Large paragraph (P2):</strong> This demonstrates
            <em>italic</em>, <strong>bold</strong>, and
          ...
          <!-- Warning callout -->
          <div
            class="flex items-start gap-[var(--space-s)] p-[var(--space-m)] bg-[var(--theme-15)] rounded-lg border border-[var(--theme-text-30)]"
            data-speed="1.04"
          >
            <Icon
            ...
            <div>
              <p
                class="ibm-plex-sans-jp-mobile-p1 md:ibm-plex-sans-jp-desktop-p1 text-[var(--theme-text-100)] mb-[var(--space-2xs)]"
              >
                <strong>Callout boxes:</strong> Use different background
                opacities for emphasis
              </p>
              <p
                class="ibm-plex-sans-jp-mobile-caption md:ibm-plex-sans-jp-desktop-caption text-[var(--theme-text-60)]"
              >
        ...
        >
          ...
          <pre
            class="p-[var(--space-m)] bg-[var(--theme-5)] border border-[var(--theme-text-15)] rounded-lg overflow-x-auto"
          ><code class="ibm-plex-sans-jp-mobile-p1 text-[var(--theme-text-100)] font-mono text-sm">// Example: Using theme tokens
const heading = {
  ...
  letterSpacing: 'var(--tracking-display-2)',
        ...
        >
          ...
          >
            <Icon
              ...
              class="icon icon-2xl icon-60 mx-auto mb-[var(--space-xs)]"
            />
            <h5
              class="pp-eiko-mobile-h3 text-[var(--theme-text-100)] mb-[var(--space-2xs)]"
            >
              Fast
            </h5>
            <p
              class="ibm-plex-sans-jp-mobile-caption text-[var(--theme-text-60)]"
            >
        ...
        >
          ...
          <div class="flex gap-[var(--space-s)] justify-center flex-wrap">
            ...
            <a
              href="/dev/typography-test"
              class="nav-link text-[var(--theme-text-100)] px-[var(--space-m)] py-[var(--space-s)] border border-[var(--theme-text-15)] rounded-md ibm-plex-sans-jp-mobile-button inline-flex items-center gap-[var(--space-xs)]"
              :data-active="false"
            >
              <Icon
